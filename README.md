# vaizon-storage-server
Storage server for Vaizon Service Nodes
...
body: "hello world"
headers:
- X-Vaizon-recipient: "mypubkey"
- X-Vaizon-ttl: "86400"
- X-Vaizon-timestamp: "1540860811000"
- X-Vaizon-pow-nonce: "xxxx..."
```
# get data
```
